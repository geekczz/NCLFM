...
unsigned char Chinesechardot[16*96] = {	 
 /********************************************
 ...
 请(32) 放(33) 置(34) 容(35) 器(36)  或(37) 将(38) 取(39) 出(40) 后(41) 去(42) 皮(43) 再(44) 灌(45) 装(46) 系(47)
 *********************************************/
...
0x00,0x42,0x44,0xC8,0xD0,0x42,0x41,0x7E,0x40,0x40,0x50,0x48,0xC4,0x62,0x00,0x00,/*"系",0*/
